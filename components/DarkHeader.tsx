...
export default function DarkHeader(): React.ReactElement {
  ...
  return (
    <>
      <header className={`sticky top-0 left-0 right-0 z-50 text-white ${scrolled ? 'backdrop-blur-md bg-black/70 shadow-sm' : 'bg-black'}`}>
